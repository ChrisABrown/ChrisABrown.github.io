...
export class AuthorizerWrapper {
  ...
  private createUserPool() {
    this.userPool = new UserPool(this.scope, 'TacosUserPool', {
      userPoolName: 'TacosUserPool',
  ...
  private addUserPoolClient() {
    this.userPoolClient = this.userPool.addClient('TacosUserPoolClient', {
      userPoolClientName: 'TacosUserPool-Client',
      authFlows: {
  ...
  private createAuthorizer() {
    this.authorizer = new CognitoUserPoolsAuthorizer(
      ...
      'TacosUserAuthorizer',
      {
        ...
        authorizerName: 'TacosUserAuthorizer',
  ...
  private createAdminGroup() {
    new CfnUserPoolGroup(this.scope, 'TacosAdmin', {
      groupName: 'TacosAdmin',
