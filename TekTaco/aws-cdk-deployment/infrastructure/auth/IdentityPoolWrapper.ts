...
export class IdentityPoolWrapper {
  ...
  private initializeIdentityPool() {
    this.identityPool = new CfnIdentityPool(this.scope, 'TacosIdentityPool', {
    ...
    new CfnOutput(this.scope, 'TacosIdentityPoolId', {
  ...
  private initializeRoles() {
    ...
    this.unauthenticatedRole = new Role(this.scope, 'TacosUnAuthRole', {
      assumedBy: new FederatedPrincipal(
        'cognito-identity.amazonaws.com',
        {
          StringEquals: {
